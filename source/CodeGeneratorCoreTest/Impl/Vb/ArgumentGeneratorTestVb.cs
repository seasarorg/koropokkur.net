...
{
    [TestFixture]
    public class ArgumentGeneratorTestVb
    {
        [Test]
        public void TestGenerateCode_Params()
        {
            const string EXPECT_CODE = "Optional hoges As Object = Nothing";

            ArgumentGeneratorVb generator = new ArgumentGeneratorVb();
        ...
        {
            const string EXPECT_CODE = "ByRef huge As Integer";

            ArgumentGeneratorVb generator = new ArgumentGeneratorVb();
            generator.Reference = EnumArgumentReference.Ref;
            generator.ArgumentName = "huge";
            generator.ArgumentTypeName = "Integer";
        ...
        {
            const string EXPECT_CODE = "ByRef huga As Long";
